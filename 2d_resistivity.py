...
for X_fixed in X_positions:
    plt.plot(df_res.y_avg, df_res['rho_'+str(X_fixed)], marker='o', linestyle='-', label=f'Resistivity at X={X_fixed}')
...
plt.title('Average resistivity variation along Y (0 to -0.5 m Depth)')
plt.grid(True)
